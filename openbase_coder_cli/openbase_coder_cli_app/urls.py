...
urlpatterns = [
    ...
    path(
        ...
        marketplace_skills_catalog,
        name="marketplace-skills-catalog",
    ),
    path(
    ...
    path(
        "marketplace/routines/catalog/",
        marketplace_routines_catalog,
        name="marketplace-routines-catalog",
    ),
    path(
        "marketplace/routines/install/",
        marketplace_routines_install,
        name="marketplace-routines-install",
    ),
    path(
        "marketplace/recommended-prompt/",
        marketplace_recommended_prompt,
        name="marketplace-recommended-prompt",
    ),
